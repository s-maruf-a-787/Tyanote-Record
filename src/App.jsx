...
const [theme, setTheme] = useState(
  ...
  const members = [
    ...
    const accounts = {
    "founder": [
    { balance: "8,700.00", status: "Total Payable" },
    { balance: "2,500.00", status: "Total Paid" },
    { balance: "6,200.00", status: "Total Due" },
    ...
    "ceo": [
    { balance: "13,050.00", status: "Total Payable" },
    { balance: "00.00", status: "Total Paid" },
    { balance: "13,050.00", status: "Total Due" },
    { balance: "00.00", status: "Total Revenue" },
  ],
    "business analyst": [
    { balance: "17,400.00", status: "Total Payable" },
    { balance: "51,000.00", status: "Total Paid" },
    { balance: "-33,600.00", status: "Total Due" },
    { balance: "00.00", status: "Total Revenue" },
  ],
    "lead researcher": [
    { balance: "2,600.00", status: "Total Payable" },
    { balance: "750.00", status: "Total Paid" },
    { balance: "1,850.00", status: "Total Due" },
    { balance: "00.00", status: "Total Revenue" },
  ],
    "content writer": [
    { balance: "15,650.00", status: "Total Payable" },
    { balance: "00.00", status: "Total Paid" },
    { balance: "15,650.00", status: "Total Due" },
    { balance: "00.00", status: "Total Revenue" },
  ],
    "junior researcher": [
    { balance: "15,650.00", status: "Total Payable" },
  ...
  const costs = {
    "one-time": [
      ...
      { item: "Promo Video", amount: 150 },
    ],
    "per-month": [
      { item: "Frontend Hosting - Vercel", amount: 40 },
      { item: "Backend Hosting - Render", amount: 45 },
      { item: "Database - MongoDB Atlas", amount: 55 },
      { item: "File Storage - Firebase Storage", amount: 30 },
      { item: "AI API", amount: 30 },
      { item: "Email - 10 users", amount: 170 },
      { item: "Email Automation", amount: 30 },
      { item: "CI/CD Pipeline", amount: 30 },
      { item: "Branding & Marketing - Facebook and Youtube", amount: 650 },
    ],
    "per-year": [
      { item: "Domain & SSL Certificate", amount: 25 },
  ...
  const investmentSteps = {
    "1st": {
      ...
      expenses: [
        { item: "Doamin", amount: 25 },
        { item: "Email", amount: 170 },
    ...
    "2nd": {
      ...
      expenses: [
        ...
        { item: "Promo Video", amount: 150 },
        { item: "Hosting & Storage", amount: 260 },
      ],
    },
    Final: {
      ...
      expenses: [
        ...
        { item: "Marketing & Branding", amount: 650 },
      ],
    },
  };
